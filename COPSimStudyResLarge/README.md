...
the copula dependence parameter theta were obtained using ML, the inversion of Kendall''s tau, and
a p-value weighted average of the two in combination with the Frank, the Gumbel, and the Clayton
