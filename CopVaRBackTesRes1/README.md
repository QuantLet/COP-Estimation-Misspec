...
Frank, the Gumbel, and the Clayton copula for a series of AR-GJR-GARCH residuals from returns of DJ
and DAX. The considered time span is 26.08.2005 to 13.08.2015. The moving window is 250.'

Keywords : 'Copula, Gumbel, Frank, Clayton, estimation, dependence, maximum-likelihood‚
Kendall''s Tau, VaR, GARCH'
